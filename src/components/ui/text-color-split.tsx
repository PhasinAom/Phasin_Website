...
export function TextColorSplit() {
  return (
    <div className="bg-black">
      <div className="bg-black py-8">
        <div className="bg-black">
          <div className="relative p-8 w-full h-full border border-[#E1E0CC]/10 [mask-image:radial-gradient(200rem_24rem_at_center,white,transparent)]">
            <h1 className="tracking-tighter flex select-none px-3 py-2 flex-col items-center justify-center text-center text-7xl font-extrabold leading-none sm:text-8xl md:flex-col lg:flex-row lg:justify-center">
